...
namespace RE
{
	struct NullMovementState : public IMovementState, public BSTSingletonImplicit<NullMovementState>
	{
		...
		bool                 DoMakeDefaultMovementParameters(IMovementParametersPtr&) const override { return false; }  // 0E
		IMovementParameters& DoGetDefaultMovementParameters() const override;                                           // 0F
		bool                 mb_getCurSpeeds(Movement::mb_CurrentSpeeds&) const override { return false; }              // 10
